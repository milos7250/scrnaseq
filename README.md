...
## Deviations from the original nf-core/scrnaseq

This is a fork of the original nf-core/scrnaseq pipeline. The following changes have been made:

- A subworkflow for filtering and trimming of fastq files using Cutadapt has been added. Inspect `subworkflows/local/fastq_trim_cutadapt_fastqc/main.nf` for details.
